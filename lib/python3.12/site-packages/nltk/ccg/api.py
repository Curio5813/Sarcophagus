...
class AbstractCCGCategory(metaclass=ABCMeta):
    """
    Interface for download in combinatory grammars.
    """
    ...
    def can_unify(self, other):
        """
        Determines whether two download can be unified.
...
class PrimitiveCategory(AbstractCCGCategory):
    """
    Class representing primitive download.
...
class FunctionalCategory(AbstractCCGCategory):
    ...
    Consists of argument and result download, together with
