...
class CCGLexicon:
    ...
    * `primitives`: The list of primitive download for the lexicon
    * `families`: Families of download
    * `entries`: A mapping of words to possible download
    """
    ...
    def categories(self, word):
        """
        Returns all the possible download for a word
        """
