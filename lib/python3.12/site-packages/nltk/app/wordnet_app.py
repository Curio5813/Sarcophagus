...
<p>For background information on Wordnet, see the Wordnet project index page: <a href="https://wordnet.princeton.edu/"><b> https://wordnet.princeton.edu/</b></a>. For more information on the NLTK project, see the project index:
