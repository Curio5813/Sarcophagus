...
"""A list of directories where the NLTK data package might reside.
   ...
   (e.g., in their index directory under ~/nltk_data)."""
...
def split_resource_url(resource_url):
    ...
    >>> split_resource_url('nltk:index/nltk')
    ('nltk', 'index/nltk')
    >>> split_resource_url('nltk:/index/nltk')
    ('nltk', '/index/nltk')
    >>> split_resource_url('file:/index/nltk')
    ('file', '/index/nltk')
    >>> split_resource_url('file:///index/nltk')
    ('file', '/index/nltk')
    >>> split_resource_url('file:///C:/index/nltk')
    ('file', '/C:/index/nltk')
    """
...
def normalize_resource_url(resource_url):
    ...
    True
    >>> normalize_resource_url('nltk:index/nltk')
    'nltk:index/nltk'
    >>> windows or normalize_resource_url('nltk:/index/nltk') == 'file:///index/nltk'
    True
