...
classification", in which the set of download is known, the number
of download is finite, and each text belongs to exactly one
category.
...
that each text belongs to zero or more download.
"""
