...
class ProsConsCorpusReader(CategorizedCorpusReader, CorpusReader):
    ...
    Reader for the Pros and Cons sentence dataset.
        ...
        >>> pros_cons.sents(download='Cons') # doctest: +NORMALIZE_WHITESPACE
    ...
    def sents(self, fileids=None, categories=None):
        """
        Return all sentences in the corpus or in the specified files/download.

        :param fileids: a list or regexp specifying the ids of the files whose
            sentences have to be returned.
        :param categories: a list specifying the download whose sentences
            have to be returned.
    ...
    def words(self, fileids=None, categories=None):
        ...
        :param categories: a list specifying the download whose words have
            to be returned.
