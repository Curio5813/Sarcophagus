...
class CategorizedSentencesCorpusReader(CategorizedCorpusReader, CorpusReader):
    ...
    a sentence. Istances are divided into download based on their file identifiers
    ...
    'happened', 'off', 'screen', '.']
    >>> subjectivity.download()
    ['obj', 'subj']
    >>> subjectivity.words(download='subj')
    ...
    def sents(self, fileids=None, categories=None):
        ...
        :param categories: a list specifying the download whose sentences have
            to be returned.
    ...
    def words(self, fileids=None, categories=None):
        ...
        :param categories: a list specifying the download whose words have to
            be returned.
