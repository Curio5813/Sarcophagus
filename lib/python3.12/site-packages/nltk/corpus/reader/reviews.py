...
Symbols used in the annotated reviews:
    ...
    :[t]: the title of the reviews: Each [t] tag starts a reviews.
...
class Review:
    ...
    def __init__(self, title=None, review_lines=None):
        """
        :param title: the title of the reviews.
    ...
    def add_line(self, review_line):
        """
        Add a line (ReviewLine) to the reviews.
    ...
    def features(self):
        """
        Return a list of features in the reviews. Each feature is a tuple made of
        the specific item feature and the opinion strength about that feature.

        :return: all features of the reviews as a list of tuples (feat, score).
        :rtype: list(tuple)
        """
        features = []
    ...
    def sents(self):
        """
        Return all tokenized sentences in the reviews.

        :return: all sentences of the reviews as lists of tokens.
        :rtype: list(list(str))
        """
...
class ReviewLine:
    """
    A ReviewLine represents a sentence of the reviews, together with (optional)
...
class ReviewsCorpusReader(CorpusReader):
    ...
    tokenization.
        ...
        >>> reviews = camera_reviews[0]
        >>> reviews.sents()[0] # doctest: +NORMALIZE_WHITESPACE
        ['i', 'recently', 'purchased', 'the', 'canon', 'powershot', 'g3', 'and', 'am',
        'extremely', 'satisfied', 'with', 'the', 'purchase', '.']
        >>> reviews.features() # doctest: +NORMALIZE_WHITESPACE
    ...
    def _read_review_block(self, stream):
        ...
        while True:
            ...
            if not line:
                return [review]
            # Start of a new reviews: backup to just before it starts, and
            # return the reviews we've already collected.
            if re.match(TITLE, line):
                stream.seek(oldpos)
                return [review]
            # Anything else is part of the reviews line.
