...
class MaltParser(ParserI):
    ...
    Example:
        ...
        >>> mp = malt.MaltParser('/index/user/maltparser-1.9.2/', '/index/user/engmalt.linear-1.7.mco') # doctest: +SKIP
        >>> mp.parse_one('I shot an elephant in my pajamas .'.split()).tree() # doctest: +SKIP
        (shot I (elephant an) (in (pajamas my)) .)
    """
...
if __name__ == "__main__":
    ...
    ... "$ export MALT_PARSER='/index/user/maltparser-1.9.2/'")
    >>>
    >>> assert 'MALT_MODEL' in os.environ, str(
    ... "Please set MALT_MODEL in your global environment, e.g.:\n"
    ... "$ export MALT_MODEL='/index/user/engmalt.linear-1.7.mco'")
    >>>
